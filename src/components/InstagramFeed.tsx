  ...
  return (
    <section className="py-16 lg:py-24 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {/* Uniform branded tiles until fresh WooCommerce Instagram plugin is connected */}
          {FALLBACK_CARDS.map((label) => (
            <FallbackTile key={label} label={label} />
          ))}

          {/* [NOTE FOR FUTURE PLUGIN SYNC]
             Once a fresh Instagram plugin is configured in WooCommerce,
             un-comment the code below to switch back to dynamic Instagram photos:
